export const balancePoolAbi = [
  {
    inputs: [
      { internalType: 'contract IERC20', name: '_ludoToken', type: 'address' },
    ],
  ...
  { inputs: [], name: 'UserMismatch', type: 'error' },
  {
    anonymous: false,
    inputs: [
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_validityWindow', type: 'uint256' },
    ],
